...
mpv $GAMEDIR/mattflix.webm &> /dev/null

$ESUDO chmod 666 /dev/uinput
$GPTOKEYB "mcli" -c ./mcli.gptk &
./mcli -e /mnt/sdcard/ports/mattflix/mattflix 
...
if [ -f /tmp/mreader.rom ]; then
    ...
    rm /tmp/mreader.rom
    /opt/muos/script/launch/ext-mreader.sh "Book" "ext-mreader-landscape" "$ROM"
fi
